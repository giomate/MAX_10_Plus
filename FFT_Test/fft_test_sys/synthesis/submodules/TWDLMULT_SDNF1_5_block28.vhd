-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block28.vhd
...
ENTITY TWDLMULT_SDNF1_5_block28 IS
  PORT( clk                               :   IN    std_logic;
        enb_1_64_0                        :   IN    std_logic;
        dout_61_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_61_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        ...
        twdl_5_59_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_59_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_60_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_60_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_60_vld                     :   IN    std_logic;
...
END TWDLMULT_SDNF1_5_block28;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block28 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block102
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block103
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block102
    USE ENTITY work.Complex4Multiply_block102(rtl);

  FOR ALL : Complex4Multiply_block103
    USE ENTITY work.Complex4Multiply_block103(rtl);

  -- Signals
  SIGNAL dout_61_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dout_61_im_signed                : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block102
    PORT MAP( clk => clk,
              ...
              twdl_5_59_re => twdl_5_59_re,  -- sfix12_En10
              twdl_5_59_im => twdl_5_59_im,  -- sfix12_En10
              softReset => softReset,
  ...
  u_MUL4_2 : Complex4Multiply_block103
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_5_60_re => twdl_5_60_re,  -- sfix12_En10
              twdl_5_60_im => twdl_5_60_im,  -- sfix12_En10
              softReset => softReset,
