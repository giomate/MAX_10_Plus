-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block27.vhd
...
ENTITY RADIX22FFT_SDNF2_6_block27 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_57_re_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_57_im_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
  ...
  BEGIN
    ...
    IF rotate_57 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_57_re_signed, 13) + resize(dout_59_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_57_re_signed, 13) - resize(dout_59_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_57_im_signed, 13) + resize(dout_59_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_57_im_signed, 13) - resize(dout_59_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_57_re_signed, 13) + resize(dout_59_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_57_re_signed, 13) - resize(dout_59_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_57_im_signed, 13) + resize(dout_59_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_57_im_signed, 13) - resize(dout_59_im_signed, 13);
    END IF;
