-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_6_block18
...
ENTITY RADIX22FFT_SDNF2_6_block18 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_39_re                        :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_39_im                        :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_40_re_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_40_im_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_6_vld                        :   OUT   std_logic
        );
END RADIX22FFT_SDNF2_6_block18;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_6_block18 IS
  ...
  SIGNAL dout_39_re_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_39_im_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_40_re_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_40_im_tmp                   : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_38_im_signed,
       dout_38_re_signed, dout_40_im_signed, dout_40_re_signed, rotate_39)
  ...
  BEGIN
    ...
    IF rotate_39 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_38_re_signed, 13) + resize(dout_40_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_38_re_signed, 13) - resize(dout_40_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_38_im_signed, 13) + resize(dout_40_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_38_im_signed, 13) - resize(dout_40_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_38_re_signed, 13) + resize(dout_40_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_38_re_signed, 13) - resize(dout_40_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_38_im_signed, 13) + resize(dout_40_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_38_im_signed, 13) - resize(dout_40_im_signed, 13);
    END IF;
    sra_temp := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf1_re_reg, 1);
    dout_39_re_tmp <= sra_temp(11 DOWNTO 0);
    sra_temp_0 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf1_im_reg, 1);
    dout_39_im_tmp <= sra_temp_0(11 DOWNTO 0);
    sra_temp_1 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf2_re_reg, 1);
    dout_40_re_tmp <= sra_temp_1(11 DOWNTO 0);
    sra_temp_2 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf2_im_reg, 1);
    dout_40_im_tmp <= sra_temp_2(11 DOWNTO 0);
  ...
  dout_40_re_1 <= std_logic_vector(dout_40_re_tmp);

  dout_40_im_1 <= std_logic_vector(dout_40_im_tmp);
