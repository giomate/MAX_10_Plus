-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block16
...
ENTITY TWDLMULT_SDNF1_3_block16 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_35_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_35_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_36_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_36_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_36_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_35_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_35_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_36_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_36_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_35_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block16;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block16 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block30
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block31
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block30
    USE ENTITY work.Complex4Multiply_block30(rtl);

  FOR ALL : Complex4Multiply_block31
    USE ENTITY work.Complex4Multiply_block31(rtl);
  ...
  SIGNAL twdlXdin_35_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_35_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_36_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_36_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block30
    PORT MAP( clk => clk,
              ...
              twdl_3_35_re => twdl_3_35_re,  -- sfix12_En10
              twdl_3_35_im => twdl_3_35_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_35_re => twdlXdin_35_re_tmp,  -- sfix12
              twdlXdin_35_im => twdlXdin_35_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block31
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_36_re => twdl_3_36_re,  -- sfix12_En10
              twdl_3_36_im => twdl_3_36_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_36_re => twdlXdin_36_re_tmp,  -- sfix12
              twdlXdin_36_im => twdlXdin_36_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_35_vld
              );
