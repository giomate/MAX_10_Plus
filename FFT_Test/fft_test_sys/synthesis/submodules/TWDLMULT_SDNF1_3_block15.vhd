-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block15.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block15
...
ENTITY TWDLMULT_SDNF1_3_block15 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_33_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_33_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_34_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_34_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_34_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_33_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_33_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_34_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_34_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_33_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block15;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block15 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block29
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block29
    USE ENTITY work.Complex4Multiply_block29(rtl);
  ...
  SIGNAL twdlXdin_34_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_34_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_2 : Complex4Multiply_block29
    PORT MAP( clk => clk,
              ...
              twdl_3_34_re => twdl_3_34_re,  -- sfix12_En10
              twdl_3_34_im => twdl_3_34_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_34_re => twdlXdin_34_re_tmp,  -- sfix12
              twdlXdin_34_im => twdlXdin_34_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_33_vld
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_re_dly1 <= dout_33_re_signed;
      END IF;
    END IF;
  ...
  twdlXdin_33_re <= std_logic_vector(din1_re_dly9);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_im_dly1 <= dout_33_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_33_im <= std_logic_vector(din1_im_dly9);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_re_dly1 <= dout_35_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_im_dly1 <= dout_35_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_34_re <= twdlXdin_34_re_tmp;

  twdlXdin_34_im <= twdlXdin_34_im_tmp;
