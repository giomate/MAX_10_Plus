-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\Complex4Multiply_block70.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block70
...
ENTITY Complex4Multiply_block70 IS
...
END Complex4Multiply_block70;


ARCHITECTURE rtl OF Complex4Multiply_block70 IS
...
BEGIN
  ...
  twdlXdin_16_re_tmp <= mulResFP_re(21 DOWNTO 10);

  twdlXdin_16_re <= std_logic_vector(twdlXdin_16_re_tmp);

  twdlXdin_16_im_tmp <= mulResFP_im(21 DOWNTO 10);
