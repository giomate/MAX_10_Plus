-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLROM_3_59.vhd
...
-- 
-- Module: TWDLROM_3_59
-- Source Path: max_10_frequency_index/max_10_index_frequency/FFT_streamer/FFT HDL Optimized/TWDLROM_3_59
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TWDLROM_3_59 IS
  PORT( clk                               :   IN    std_logic;
        enb_1_64_0                        :   IN    std_logic;
        dout_2_vld                        :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdl_3_59_re                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_59_im                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_59_vld                     :   OUT   std_logic
        );
END TWDLROM_3_59;


ARCHITECTURE rtl OF TWDLROM_3_59 IS
  ...
  SIGNAL twdl_3_59_re_tmp                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_3_59_im_tmp                 : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_3_59_re_tmp <= twdlIn_re;
    twdl_3_59_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_3_59_re <= std_logic_vector(twdl_3_59_re_tmp);

  twdl_3_59_im <= std_logic_vector(twdl_3_59_im_tmp);

  intdelay_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        twdl_3_59_vld <= twdlAddrVld;
      END IF;
    END IF;
