-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block29.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block29
...
ENTITY TWDLMULT_SDNF1_3_block29 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_61_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_61_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_62_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_62_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_62_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_61_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_61_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_62_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_62_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_61_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block29;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block29 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block55
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block56
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block55
    USE ENTITY work.Complex4Multiply_block55(rtl);

  FOR ALL : Complex4Multiply_block56
    USE ENTITY work.Complex4Multiply_block56(rtl);
  ...
  SIGNAL twdlXdin_61_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_61_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_62_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_62_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block55
    PORT MAP( clk => clk,
              ...
              twdl_3_61_re => twdl_3_61_re,  -- sfix12_En10
              twdl_3_61_im => twdl_3_61_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_61_re => twdlXdin_61_re_tmp,  -- sfix12
              twdlXdin_61_im => twdlXdin_61_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block56
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_62_re => twdl_3_62_re,  -- sfix12_En10
              twdl_3_62_im => twdl_3_62_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_62_re => twdlXdin_62_re_tmp,  -- sfix12
              twdlXdin_62_im => twdlXdin_62_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_61_vld
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_re_dly1 <= dout_58_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_im_dly1 <= dout_58_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_re_dly1 <= dout_60_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_im_dly1 <= dout_60_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_61_re <= twdlXdin_61_re_tmp;

  twdlXdin_61_im <= twdlXdin_61_im_tmp;

  twdlXdin_62_re <= twdlXdin_62_re_tmp;

  twdlXdin_62_im <= twdlXdin_62_im_tmp;
