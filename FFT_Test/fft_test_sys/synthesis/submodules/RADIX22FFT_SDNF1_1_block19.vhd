-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF1_1_block19.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF1_1_block19
...
ENTITY RADIX22FFT_SDNF1_1_block19 IS
...
END RADIX22FFT_SDNF1_1_block19;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block19 IS
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       twdlXdin_21_im_signed, twdlXdin_21_re_signed, twdlXdin_53_im_signed,
       twdlXdin_53_re_signed)
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_21_re_signed, 13) + resize(twdlXdin_53_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_21_re_signed, 13) - resize(twdlXdin_53_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_21_im_signed, 13) + resize(twdlXdin_53_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_21_im_signed, 13) - resize(twdlXdin_53_im_signed, 13);
    END IF;
