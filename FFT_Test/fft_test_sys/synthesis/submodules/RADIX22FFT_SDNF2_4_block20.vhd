-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_4_block20.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_4_block20
...
ENTITY RADIX22FFT_SDNF2_4_block20 IS
...
END RADIX22FFT_SDNF2_4_block20;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block20 IS
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_36_im_signed,
       dout_36_re_signed, dout_44_im_signed, dout_44_re_signed, rotate_43)
  ...
  BEGIN
    ...
    IF rotate_43 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_36_re_signed, 13) + resize(dout_44_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_36_re_signed, 13) - resize(dout_44_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_36_im_signed, 13) + resize(dout_44_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_36_im_signed, 13) - resize(dout_44_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_36_re_signed, 13) + resize(dout_44_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_36_re_signed, 13) - resize(dout_44_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_36_im_signed, 13) + resize(dout_44_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_36_im_signed, 13) - resize(dout_44_im_signed, 13);
    END IF;
