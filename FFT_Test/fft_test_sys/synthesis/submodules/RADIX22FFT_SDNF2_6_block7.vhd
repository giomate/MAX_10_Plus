-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_6_block7
...
ENTITY RADIX22FFT_SDNF2_6_block7 IS
...
END RADIX22FFT_SDNF2_6_block7;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_6_block7 IS
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_19_im_signed, dout_19_re_signed, dout_1_vld, rotate_17)
  ...
  BEGIN
    ...
    IF rotate_17 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_17_re_signed, 13) + resize(dout_19_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_17_re_signed, 13) - resize(dout_19_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_17_im_signed, 13) + resize(dout_19_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_17_im_signed, 13) - resize(dout_19_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_17_re_signed, 13) + resize(dout_19_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_17_re_signed, 13) - resize(dout_19_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_17_im_signed, 13) + resize(dout_19_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_17_im_signed, 13) - resize(dout_19_im_signed, 13);
    END IF;
