-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_5_block12
...
ENTITY TWDLMULT_SDNF1_5_block12 IS
...
END TWDLMULT_SDNF1_5_block12;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block12 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block78
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block79
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block78
    USE ENTITY work.Complex4Multiply_block78(rtl);

  FOR ALL : Complex4Multiply_block79
    USE ENTITY work.Complex4Multiply_block79(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block78
    PORT MAP( clk => clk,
              ...
              twdl_5_27_re => twdl_5_27_re,  -- sfix12_En10
              twdl_5_27_im => twdl_5_27_im,  -- sfix12_En10
              softReset => softReset,
  ...
  u_MUL4_2 : Complex4Multiply_block79
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
