-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\Complex4Multiply_block63.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block63
...
ENTITY Complex4Multiply_block63 IS
...
END Complex4Multiply_block63;


ARCHITECTURE rtl OF Complex4Multiply_block63 IS
  ...
  SIGNAL twdl_5_7_re_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_re_reg                      : signed(11 DOWNTO 0) := to_signed(16#000#, 12);  -- sfix12_En10
  SIGNAL twdl_5_7_im_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  twdl_5_7_re_signed <= signed(twdl_5_7_re);

  intdelay_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        twdl_re_reg <= twdl_5_7_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_5_7_im_signed <= signed(twdl_5_7_im);

  intdelay_3_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        twdl_im_reg <= twdl_5_7_im_signed;
      END IF;
    END IF;
