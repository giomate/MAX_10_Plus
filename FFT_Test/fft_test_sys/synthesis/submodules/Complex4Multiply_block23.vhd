-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\Complex4Multiply_block23.vhd
...
ENTITY Complex4Multiply_block23 IS
...
END Complex4Multiply_block23;


ARCHITECTURE rtl OF Complex4Multiply_block23 IS
  ...
  SIGNAL twdl_3_29_re_signed              : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_re_reg                      : signed(11 DOWNTO 0) := to_signed(16#000#, 12);  -- sfix12_En10
  SIGNAL twdl_3_29_im_signed              : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL twdlXdin_29_re_tmp               : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_29_im_tmp               : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  twdlXdin_29_re_tmp <= mulResFP_re(21 DOWNTO 10);

  twdlXdin_29_re <= std_logic_vector(twdlXdin_29_re_tmp);

  twdlXdin_29_im_tmp <= mulResFP_im(21 DOWNTO 10);
