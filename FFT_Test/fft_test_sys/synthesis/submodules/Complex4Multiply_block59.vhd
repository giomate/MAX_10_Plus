-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\Complex4Multiply_block59.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block59
...
ENTITY Complex4Multiply_block59 IS
...
END Complex4Multiply_block59;


ARCHITECTURE rtl OF Complex4Multiply_block59 IS
  ...
  SIGNAL twdlXdin_2_re_tmp                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_2_im_tmp                : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  twdlXdin_2_re_tmp <= mulResFP_re(21 DOWNTO 10);

  twdlXdin_2_re <= std_logic_vector(twdlXdin_2_re_tmp);

  twdlXdin_2_im_tmp <= mulResFP_im(21 DOWNTO 10);
