-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block24.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_5_block24
...
ENTITY TWDLMULT_SDNF1_5_block24 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_5_51_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_51_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_52_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_52_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_52_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_51_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_51_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_52_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_52_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_51_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_5_block24;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block24 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block96
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block97
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block96
    USE ENTITY work.Complex4Multiply_block96(rtl);

  FOR ALL : Complex4Multiply_block97
    USE ENTITY work.Complex4Multiply_block97(rtl);
  ...
  SIGNAL twdlXdin_51_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_51_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_52_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_52_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block96
    PORT MAP( clk => clk,
              ...
              twdl_5_51_re => twdl_5_51_re,  -- sfix12_En10
              twdl_5_51_im => twdl_5_51_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_51_re => twdlXdin_51_re_tmp,  -- sfix12
              twdlXdin_51_im => twdlXdin_51_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block97
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_5_52_re => twdl_5_52_re,  -- sfix12_En10
              twdl_5_52_im => twdl_5_52_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_52_re => twdlXdin_52_re_tmp,  -- sfix12
              twdlXdin_52_im => twdlXdin_52_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_51_vld
              );
