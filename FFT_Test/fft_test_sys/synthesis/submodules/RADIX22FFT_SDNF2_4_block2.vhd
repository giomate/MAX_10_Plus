-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_4_block2.vhd
  ...
  BEGIN
    ...
    IF rotate_7 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_4_re_signed, 13) + resize(dout_8_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_4_re_signed, 13) - resize(dout_8_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_4_im_signed, 13) + resize(dout_8_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_4_im_signed, 13) - resize(dout_8_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_4_re_signed, 13) + resize(dout_8_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_4_re_signed, 13) - resize(dout_8_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_4_im_signed, 13) + resize(dout_8_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_4_im_signed, 13) - resize(dout_8_im_signed, 13);
    END IF;
