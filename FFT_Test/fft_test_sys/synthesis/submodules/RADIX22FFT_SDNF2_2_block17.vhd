-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_2_block17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_2_block17
...
ENTITY RADIX22FFT_SDNF2_2_block17 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_38_re_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_38_im_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_2_vld                        :   OUT   std_logic
        );
END RADIX22FFT_SDNF2_2_block17;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_2_block17 IS
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_38_re_signed, dout_6_im_signed, dout_6_re_signed, rotate_37)
  ...
  BEGIN
    ...
    IF rotate_37 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_6_re_signed, 13) + resize(dout_38_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_6_re_signed, 13) - resize(dout_38_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_6_im_signed, 13) + resize(dout_38_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_6_im_signed, 13) - resize(dout_38_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_6_re_signed, 13) + resize(dout_38_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_6_re_signed, 13) - resize(dout_38_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_6_im_signed, 13) + resize(dout_38_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_6_im_signed, 13) - resize(dout_38_im_signed, 13);
    END IF;
  ...
  dout_38_re_1 <= std_logic_vector(dout_38_re_tmp);

  dout_38_im_1 <= std_logic_vector(dout_38_im_tmp);
