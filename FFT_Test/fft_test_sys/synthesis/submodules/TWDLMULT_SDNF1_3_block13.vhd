-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block13.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block13 IS
  ...
  COMPONENT Complex4Multiply_block23
    PORT( clk                             :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block24
    PORT( clk                             :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block23
    USE ENTITY work.Complex4Multiply_block23(rtl);

  FOR ALL : Complex4Multiply_block24
    USE ENTITY work.Complex4Multiply_block24(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block23
    PORT MAP( clk => clk,
  ...
  u_MUL4_2 : Complex4Multiply_block24
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
