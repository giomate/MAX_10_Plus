-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF1_1_block21.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF1_1_block21
...
ENTITY RADIX22FFT_SDNF1_1_block21 IS
...
END RADIX22FFT_SDNF1_1_block21;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block21 IS
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       twdlXdin_23_im_signed, twdlXdin_23_re_signed, twdlXdin_55_im_signed,
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_23_re_signed, 13) + resize(twdlXdin_55_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_23_re_signed, 13) - resize(twdlXdin_55_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_23_im_signed, 13) + resize(twdlXdin_55_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_23_im_signed, 13) - resize(twdlXdin_55_im_signed, 13);
    END IF;
