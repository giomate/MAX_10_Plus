-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block23.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_5_block23
...
ENTITY TWDLMULT_SDNF1_5_block23 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_5_49_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_49_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_50_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_50_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_50_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_49_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_49_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_50_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_50_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_49_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_5_block23;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block23 IS
  ...
  SIGNAL twdlXdin_50_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_50_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block95
    PORT MAP( clk => clk,
              ...
              twdl_5_50_re => twdl_5_50_re,  -- sfix12_En10
              twdl_5_50_im => twdl_5_50_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_50_re => twdlXdin_50_re_tmp,  -- sfix12
              twdlXdin_50_im => twdlXdin_50_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_49_vld
              );
  ...
  twdlXdin_49_re <= std_logic_vector(din1_re_dly9);
  ...
  twdlXdin_49_im <= std_logic_vector(din1_im_dly9);
  ...
  twdlXdin_50_re <= twdlXdin_50_re_tmp;

  twdlXdin_50_im <= twdlXdin_50_im_tmp;
