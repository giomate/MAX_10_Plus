-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block13.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block13 IS
  ...
  COMPONENT Complex4Multiply_block80
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block80
    USE ENTITY work.Complex4Multiply_block80(rtl);
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block80
    PORT MAP( clk => clk,
  ...
  twdlXdin_29_re <= std_logic_vector(din1_re_dly9);
  ...
  twdlXdin_29_im <= std_logic_vector(din1_im_dly9);
