-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block21.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_6_block21
...
ENTITY RADIX22FFT_SDNF2_6_block21 IS
  PORT( clk                               :   IN    std_logic;
        enb_1_64_0                        :   IN    std_logic;
        rotate_45                         :   IN    std_logic;  -- ufix1
        dout_45_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_45_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_47_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_47_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_1_vld                        :   IN    std_logic;
        softReset                         :   IN    std_logic;
        dout_45_re_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_45_im_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
...
END RADIX22FFT_SDNF2_6_block21;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_6_block21 IS

  -- Signals
  SIGNAL dout_45_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_45_im_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_47_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_47_im_signed                : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_45_im_signed,
       dout_45_re_signed, dout_47_im_signed, dout_47_re_signed, rotate_45)
  ...
  BEGIN
    ...
    IF rotate_45 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_45_re_signed, 13) + resize(dout_47_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_45_re_signed, 13) - resize(dout_47_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_45_im_signed, 13) + resize(dout_47_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_45_im_signed, 13) - resize(dout_47_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_45_re_signed, 13) + resize(dout_47_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_45_re_signed, 13) - resize(dout_47_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_45_im_signed, 13) + resize(dout_47_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_45_im_signed, 13) - resize(dout_47_im_signed, 13);
    END IF;
  ...
  dout_45_re_1 <= std_logic_vector(dout_45_re_tmp);

  dout_45_im_1 <= std_logic_vector(dout_45_im_tmp);
