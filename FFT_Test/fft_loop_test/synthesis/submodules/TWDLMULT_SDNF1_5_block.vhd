-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block.vhd
...
ENTITY TWDLMULT_SDNF1_5_block IS
...
END TWDLMULT_SDNF1_5_block;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block60
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block61
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block60
    USE ENTITY work.Complex4Multiply_block60(rtl);

  FOR ALL : Complex4Multiply_block61
    USE ENTITY work.Complex4Multiply_block61(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block60
    PORT MAP( clk => clk,
              ...
              twdl_5_3_re => twdl_5_3_re,  -- sfix12_En10
              twdl_5_3_im => twdl_5_3_im,  -- sfix12_En10
              softReset => softReset,
  ...
  u_MUL4_2 : Complex4Multiply_block61
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
