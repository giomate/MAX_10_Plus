-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block23.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block23
...
ENTITY TWDLMULT_SDNF1_3_block23 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_49_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_49_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_50_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_50_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_50_vld                     :   IN    std_logic;
...
END TWDLMULT_SDNF1_3_block23;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block23 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block44
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block44
    USE ENTITY work.Complex4Multiply_block44(rtl);
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block44
    PORT MAP( clk => clk,
              ...
              twdl_3_50_re => twdl_3_50_re,  -- sfix12_En10
              twdl_3_50_im => twdl_3_50_im,  -- sfix12_En10
              softReset => softReset,
