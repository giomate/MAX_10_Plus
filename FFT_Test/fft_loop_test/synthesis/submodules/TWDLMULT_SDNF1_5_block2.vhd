-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block2.vhd
...
ENTITY TWDLMULT_SDNF1_5_block2 IS
...
END TWDLMULT_SDNF1_5_block2;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block2 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block63
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block64
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block63
    USE ENTITY work.Complex4Multiply_block63(rtl);

  FOR ALL : Complex4Multiply_block64
    USE ENTITY work.Complex4Multiply_block64(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block63
    PORT MAP( clk => clk,
              ...
              twdl_5_7_re => twdl_5_7_re,  -- sfix12_En10
              twdl_5_7_im => twdl_5_7_im,  -- sfix12_En10
              softReset => softReset,
  ...
  u_MUL4_2 : Complex4Multiply_block64
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
