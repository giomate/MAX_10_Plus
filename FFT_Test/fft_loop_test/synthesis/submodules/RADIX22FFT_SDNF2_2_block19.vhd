-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_2_block19.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_2_block19
...
ENTITY RADIX22FFT_SDNF2_2_block19 IS
...
END RADIX22FFT_SDNF2_2_block19;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_2_block19 IS
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_1_vld, dout_42_im_signed, dout_42_re_signed, rotate_41)
  ...
  BEGIN
    ...
    IF rotate_41 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_10_re_signed, 13) + resize(dout_42_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_10_re_signed, 13) - resize(dout_42_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_10_im_signed, 13) + resize(dout_42_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_10_im_signed, 13) - resize(dout_42_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_10_re_signed, 13) + resize(dout_42_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_10_re_signed, 13) - resize(dout_42_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_10_im_signed, 13) + resize(dout_42_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_10_im_signed, 13) - resize(dout_42_im_signed, 13);
    END IF;
