-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block26.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block26
...
ENTITY TWDLMULT_SDNF1_3_block26 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_55_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_55_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_56_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_56_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_56_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_55_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_55_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_56_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_56_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_55_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block26;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block26 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block49
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block50
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block49
    USE ENTITY work.Complex4Multiply_block49(rtl);

  FOR ALL : Complex4Multiply_block50
    USE ENTITY work.Complex4Multiply_block50(rtl);
  ...
  SIGNAL twdlXdin_55_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_55_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_56_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_56_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block49
    PORT MAP( clk => clk,
              ...
              twdl_3_55_re => twdl_3_55_re,  -- sfix12_En10
              twdl_3_55_im => twdl_3_55_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_55_re => twdlXdin_55_re_tmp,  -- sfix12
              twdlXdin_55_im => twdlXdin_55_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block50
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_56_re => twdl_3_56_re,  -- sfix12_En10
              twdl_3_56_im => twdl_3_56_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_56_re => twdlXdin_56_re_tmp,  -- sfix12
              twdlXdin_56_im => twdlXdin_56_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_55_vld
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_re_dly1 <= dout_46_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_im_dly1 <= dout_46_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_re_dly1 <= dout_48_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_im_dly1 <= dout_48_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_55_re <= twdlXdin_55_re_tmp;

  twdlXdin_55_im <= twdlXdin_55_im_tmp;

  twdlXdin_56_re <= twdlXdin_56_re_tmp;

  twdlXdin_56_im <= twdlXdin_56_im_tmp;
