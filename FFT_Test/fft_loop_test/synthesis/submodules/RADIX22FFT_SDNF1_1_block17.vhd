-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF1_1_block17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF1_1_block17
...
ENTITY RADIX22FFT_SDNF1_1_block17 IS
...
END RADIX22FFT_SDNF1_1_block17;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block17 IS

  -- Signals
  SIGNAL twdlXdin_19_re_signed            : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_19_im_signed            : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       twdlXdin_19_re_signed, twdlXdin_1_vld, twdlXdin_51_im_signed,
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_19_re_signed, 13) + resize(twdlXdin_51_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_19_re_signed, 13) - resize(twdlXdin_51_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_19_im_signed, 13) + resize(twdlXdin_51_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_19_im_signed, 13) - resize(twdlXdin_51_im_signed, 13);
    END IF;
