-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block1.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block1 IS
  ...
  COMPONENT Complex4Multiply_block62
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block62
    USE ENTITY work.Complex4Multiply_block62(rtl);
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block62
    PORT MAP( clk => clk,
