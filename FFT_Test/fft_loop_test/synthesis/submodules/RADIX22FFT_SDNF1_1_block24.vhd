-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF1_1_block24.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF1_1_block24
...
ENTITY RADIX22FFT_SDNF1_1_block24 IS
...
END RADIX22FFT_SDNF1_1_block24;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block24 IS
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       twdlXdin_26_im_signed, twdlXdin_26_re_signed, twdlXdin_58_im_signed,
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_26_re_signed, 13) + resize(twdlXdin_58_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_26_re_signed, 13) - resize(twdlXdin_58_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_26_im_signed, 13) + resize(twdlXdin_58_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_26_im_signed, 13) - resize(twdlXdin_58_im_signed, 13);
    END IF;
