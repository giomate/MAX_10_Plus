-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLROM_5_58.vhd
...
-- 
-- Module: TWDLROM_5_58
-- Source Path: max_10_frequency_index/max_10_index_frequency/FFT_streamer/FFT HDL Optimized/TWDLROM_5_58
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TWDLROM_5_58 IS
  PORT( clk                               :   IN    std_logic;
        enb_1_64_0                        :   IN    std_logic;
        dout_4_vld                        :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdl_5_58_re                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_58_im                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_58_vld                     :   OUT   std_logic
        );
END TWDLROM_5_58;


ARCHITECTURE rtl OF TWDLROM_5_58 IS
  ...
  SIGNAL twdl_5_58_re_tmp                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_5_58_im_tmp                 : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_5_58_re_tmp <= twdlIn_re;
    twdl_5_58_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_5_58_re <= std_logic_vector(twdl_5_58_re_tmp);

  twdl_5_58_im <= std_logic_vector(twdl_5_58_im_tmp);

  intdelay_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        twdl_5_58_vld <= twdlAddrVld;
      END IF;
    END IF;
