-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_2_block28.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_2_block28
...
ENTITY RADIX22FFT_SDNF2_2_block28 IS
...
END RADIX22FFT_SDNF2_2_block28;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_2_block28 IS
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_28_re_signed, dout_60_im_signed, dout_60_re_signed, rotate_59)
  ...
  BEGIN
    ...
    IF rotate_59 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_28_re_signed, 13) + resize(dout_60_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_28_re_signed, 13) - resize(dout_60_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_28_im_signed, 13) + resize(dout_60_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_28_im_signed, 13) - resize(dout_60_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_28_re_signed, 13) + resize(dout_60_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_28_re_signed, 13) - resize(dout_60_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_28_im_signed, 13) + resize(dout_60_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_28_im_signed, 13) - resize(dout_60_im_signed, 13);
    END IF;
