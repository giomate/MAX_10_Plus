-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block21.vhd
...
ENTITY TWDLMULT_SDNF1_3_block21 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_45_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_45_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_46_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_46_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_46_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_45_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_45_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_46_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_46_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_45_vld                   :   OUT   std_logic
        );
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block21 IS
  ...
  SIGNAL twdlXdin_45_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_45_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_46_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_46_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block40
    PORT MAP( clk => clk,
              ...
              twdl_3_45_re => twdl_3_45_re,  -- sfix12_En10
              twdl_3_45_im => twdl_3_45_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_45_re => twdlXdin_45_re_tmp,  -- sfix12
              twdlXdin_45_im => twdlXdin_45_im_tmp,  -- sfix12
  ...
  u_MUL4_2 : Complex4Multiply_block41
    PORT MAP( clk => clk,
              ...
              twdl_3_46_re => twdl_3_46_re,  -- sfix12_En10
              twdl_3_46_im => twdl_3_46_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_46_re => twdlXdin_46_re_tmp,  -- sfix12
              twdlXdin_46_im => twdlXdin_46_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_45_vld
              );
