-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\RADIX22FFT_SDNF1_5_block.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_5_block IS
  ...
  COMPONENT Complex4Multiply_block28
    PORT( clk                             :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block28
    USE ENTITY work.Complex4Multiply_block28(rtl);
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block28
    PORT MAP( clk => clk,
