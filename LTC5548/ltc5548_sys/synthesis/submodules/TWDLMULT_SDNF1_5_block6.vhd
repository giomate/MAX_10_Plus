-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block6.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block6 IS
  ...
  COMPONENT Complex4Multiply_block69
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block70
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block69
    USE ENTITY work.Complex4Multiply_block69(rtl);

  FOR ALL : Complex4Multiply_block70
    USE ENTITY work.Complex4Multiply_block70(rtl);
  ...
  SIGNAL twdlXdin_15_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_15_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_16_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_16_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block69
    PORT MAP( clk => clk,
              ...
              twdl_5_15_re => twdl_5_15_re,  -- sfix12_En10
              twdl_5_15_im => twdl_5_15_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_15_re => twdlXdin_15_re_tmp,  -- sfix12
              twdlXdin_15_im => twdlXdin_15_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block70
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              softReset => softReset,
              twdlXdin_16_re => twdlXdin_16_re_tmp,  -- sfix12
              twdlXdin_16_im => twdlXdin_16_im_tmp,  -- sfix12
