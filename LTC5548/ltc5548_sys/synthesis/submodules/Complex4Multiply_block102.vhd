-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\Complex4Multiply_block102.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block102
...
ENTITY Complex4Multiply_block102 IS
...
END Complex4Multiply_block102;


ARCHITECTURE rtl OF Complex4Multiply_block102 IS
  ...
  SIGNAL twdl_5_59_re_signed              : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_re_reg                      : signed(11 DOWNTO 0) := to_signed(16#000#, 12);  -- sfix12_En10
  SIGNAL twdl_5_59_im_signed              : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL twdlXdin_59_re_tmp               : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_59_im_tmp               : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  twdl_5_59_re_signed <= signed(twdl_5_59_re);

  intdelay_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        twdl_re_reg <= twdl_5_59_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_5_59_im_signed <= signed(twdl_5_59_im);

  intdelay_3_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        twdl_im_reg <= twdl_5_59_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_59_re_tmp <= mulResFP_re(21 DOWNTO 10);

  twdlXdin_59_re <= std_logic_vector(twdlXdin_59_re_tmp);

  twdlXdin_59_im_tmp <= mulResFP_im(21 DOWNTO 10);

  twdlXdin_59_im <= std_logic_vector(twdlXdin_59_im_tmp);
