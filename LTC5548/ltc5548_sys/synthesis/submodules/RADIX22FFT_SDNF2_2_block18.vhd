-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_2_block18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_2_block18
...
ENTITY RADIX22FFT_SDNF2_2_block18 IS
...
END RADIX22FFT_SDNF2_2_block18;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_2_block18 IS
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_40_re_signed, dout_8_im_signed, dout_8_re_signed, rotate_39)
  ...
  BEGIN
    ...
    IF rotate_39 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_8_re_signed, 13) + resize(dout_40_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_8_re_signed, 13) - resize(dout_40_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_8_im_signed, 13) + resize(dout_40_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_8_im_signed, 13) - resize(dout_40_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_8_re_signed, 13) + resize(dout_40_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_8_re_signed, 13) - resize(dout_40_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_8_im_signed, 13) + resize(dout_40_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_8_im_signed, 13) - resize(dout_40_im_signed, 13);
    END IF;
