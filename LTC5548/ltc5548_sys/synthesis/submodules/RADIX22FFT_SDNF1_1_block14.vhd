-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\RADIX22FFT_SDNF1_1_block14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF1_1_block14
...
ENTITY RADIX22FFT_SDNF1_1_block14 IS
...
END RADIX22FFT_SDNF1_1_block14;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block14 IS

  -- Signals
  SIGNAL twdlXdin_16_re_signed            : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_16_im_signed            : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_16_re_signed, 13) + resize(twdlXdin_32_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_16_re_signed, 13) - resize(twdlXdin_32_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_16_im_signed, 13) + resize(twdlXdin_32_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_16_im_signed, 13) - resize(twdlXdin_32_im_signed, 13);
    END IF;
