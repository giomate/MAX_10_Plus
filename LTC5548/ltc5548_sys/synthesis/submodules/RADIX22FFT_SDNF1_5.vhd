-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\RADIX22FFT_SDNF1_5.vhd
...
END RADIX22FFT_SDNF1_5;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_5 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block27
    PORT( clk                             :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block27
    USE ENTITY work.Complex4Multiply_block27(rtl);
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block27
    PORT MAP( clk => clk,
