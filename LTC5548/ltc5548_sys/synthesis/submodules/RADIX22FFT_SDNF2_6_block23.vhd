-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block23.vhd
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_49_re_signed, dout_51_im_signed, dout_51_re_signed, rotate_49)
  ...
  BEGIN
    ...
    IF rotate_49 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_49_re_signed, 13) + resize(dout_51_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_49_re_signed, 13) - resize(dout_51_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_49_im_signed, 13) + resize(dout_51_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_49_im_signed, 13) - resize(dout_51_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_49_re_signed, 13) + resize(dout_51_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_49_re_signed, 13) - resize(dout_51_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_49_im_signed, 13) + resize(dout_51_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_49_im_signed, 13) - resize(dout_51_im_signed, 13);
    END IF;
