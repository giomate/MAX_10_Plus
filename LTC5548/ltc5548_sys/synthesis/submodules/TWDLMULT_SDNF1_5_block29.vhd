-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block29.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_5_block29
...
ENTITY TWDLMULT_SDNF1_5_block29 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_5_61_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_61_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_62_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_62_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_5_62_vld                     :   IN    std_logic;
...
END TWDLMULT_SDNF1_5_block29;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block29 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block104
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block104
    USE ENTITY work.Complex4Multiply_block104(rtl);
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block104
    PORT MAP( clk => clk,
              ...
              twdl_5_62_re => twdl_5_62_re,  -- sfix12_En10
              twdl_5_62_im => twdl_5_62_im,  -- sfix12_En10
              softReset => softReset,
  ...
  twdlXdin_61_re <= std_logic_vector(din1_re_dly9);
  ...
  twdlXdin_61_im <= std_logic_vector(din1_im_dly9);
