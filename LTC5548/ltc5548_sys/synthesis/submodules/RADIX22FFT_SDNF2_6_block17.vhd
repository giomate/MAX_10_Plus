-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_6_block17
...
ENTITY RADIX22FFT_SDNF2_6_block17 IS
  PORT( clk                               :   IN    std_logic;
        enb_1_64_0                        :   IN    std_logic;
        rotate_37                         :   IN    std_logic;  -- ufix1
        dout_37_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_37_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_39_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_39_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_1_vld                        :   IN    std_logic;
        softReset                         :   IN    std_logic;
        dout_37_re_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_37_im_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_38_re                        :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_38_im                        :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_6_vld                        :   OUT   std_logic
        );
END RADIX22FFT_SDNF2_6_block17;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_6_block17 IS

  -- Signals
  SIGNAL dout_37_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_37_im_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_39_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_39_im_signed                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dout_37_re_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_37_im_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_38_re_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_38_im_tmp                   : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_37_im_signed,
       dout_37_re_signed, dout_39_im_signed, dout_39_re_signed, rotate_37)
  ...
  BEGIN
    ...
    IF rotate_37 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_37_re_signed, 13) + resize(dout_39_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_37_re_signed, 13) - resize(dout_39_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_37_im_signed, 13) + resize(dout_39_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_37_im_signed, 13) - resize(dout_39_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_37_re_signed, 13) + resize(dout_39_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_37_re_signed, 13) - resize(dout_39_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_37_im_signed, 13) + resize(dout_39_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_37_im_signed, 13) - resize(dout_39_im_signed, 13);
    END IF;
    sra_temp := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf1_re_reg, 1);
    dout_37_re_tmp <= sra_temp(11 DOWNTO 0);
    sra_temp_0 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf1_im_reg, 1);
    dout_37_im_tmp <= sra_temp_0(11 DOWNTO 0);
    sra_temp_1 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf2_re_reg, 1);
    dout_38_re_tmp <= sra_temp_1(11 DOWNTO 0);
    sra_temp_2 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf2_im_reg, 1);
    dout_38_im_tmp <= sra_temp_2(11 DOWNTO 0);
    dout_6_vld <= Radix22ButterflyG2_NF_din_vld_dly;
  END PROCESS Radix22ButterflyG2_NF_output;


  dout_38_re <= std_logic_vector(dout_38_re_tmp);

  dout_38_im <= std_logic_vector(dout_38_im_tmp);

  dout_37_re_1 <= std_logic_vector(dout_37_re_tmp);

  dout_37_im_1 <= std_logic_vector(dout_37_im_tmp);
