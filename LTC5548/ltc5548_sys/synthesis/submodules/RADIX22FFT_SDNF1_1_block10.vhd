-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\RADIX22FFT_SDNF1_1_block10.vhd
...
ENTITY RADIX22FFT_SDNF1_1_block10 IS
...
END RADIX22FFT_SDNF1_1_block10;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block10 IS
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_12_re_signed, 13) + resize(twdlXdin_28_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_12_re_signed, 13) - resize(twdlXdin_28_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_12_im_signed, 13) + resize(twdlXdin_28_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_12_im_signed, 13) - resize(twdlXdin_28_im_signed, 13);
    END IF;
