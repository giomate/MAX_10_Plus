-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_5_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_5_block10
...
ENTITY TWDLMULT_SDNF1_5_block10 IS
...
END TWDLMULT_SDNF1_5_block10;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block10 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block75
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block76
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block75
    USE ENTITY work.Complex4Multiply_block75(rtl);

  FOR ALL : Complex4Multiply_block76
    USE ENTITY work.Complex4Multiply_block76(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block75
    PORT MAP( clk => clk,
              ...
              twdl_5_23_re => twdl_5_23_re,  -- sfix12_En10
              twdl_5_23_im => twdl_5_23_im,  -- sfix12_En10
              softReset => softReset,
  ...
  u_MUL4_2 : Complex4Multiply_block76
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
