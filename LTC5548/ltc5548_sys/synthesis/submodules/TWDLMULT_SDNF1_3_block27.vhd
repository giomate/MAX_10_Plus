-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block27.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block27
...
ENTITY TWDLMULT_SDNF1_3_block27 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_57_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_57_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_58_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_58_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_58_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_57_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_57_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_58_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_58_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_57_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block27;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block27 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block51
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block52
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block51
    USE ENTITY work.Complex4Multiply_block51(rtl);

  FOR ALL : Complex4Multiply_block52
    USE ENTITY work.Complex4Multiply_block52(rtl);
  ...
  SIGNAL twdlXdin_57_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_57_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_58_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_58_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block51
    PORT MAP( clk => clk,
              ...
              twdl_3_57_re => twdl_3_57_re,  -- sfix12_En10
              twdl_3_57_im => twdl_3_57_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_57_re => twdlXdin_57_re_tmp,  -- sfix12
              twdlXdin_57_im => twdlXdin_57_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block52
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_58_re => twdl_3_58_re,  -- sfix12_En10
              twdl_3_58_im => twdl_3_58_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_58_re => twdlXdin_58_re_tmp,  -- sfix12
              twdlXdin_58_im => twdlXdin_58_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_57_vld
              );
  ...
  twdlXdin_57_re <= twdlXdin_57_re_tmp;

  twdlXdin_57_im <= twdlXdin_57_im_tmp;

  twdlXdin_58_re <= twdlXdin_58_re_tmp;

  twdlXdin_58_im <= twdlXdin_58_im_tmp;
