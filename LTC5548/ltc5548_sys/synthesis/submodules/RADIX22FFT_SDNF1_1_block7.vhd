-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\RADIX22FFT_SDNF1_1_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF1_1_block7
...
ENTITY RADIX22FFT_SDNF1_1_block7 IS
...
END RADIX22FFT_SDNF1_1_block7;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block7 IS

  -- Signals
  SIGNAL twdlXdin_9_re_signed             : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_9_im_signed             : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_9_re_signed, 13) + resize(twdlXdin_25_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_9_re_signed, 13) - resize(twdlXdin_25_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_9_im_signed, 13) + resize(twdlXdin_25_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_9_im_signed, 13) - resize(twdlXdin_25_im_signed, 13);
    END IF;
