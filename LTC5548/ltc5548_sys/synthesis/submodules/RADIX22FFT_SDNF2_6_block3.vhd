-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_6_block3
...
ENTITY RADIX22FFT_SDNF2_6_block3 IS
...
END RADIX22FFT_SDNF2_6_block3;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_6_block3 IS
  ...
  BEGIN
    ...
    IF rotate_9 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_9_re_signed, 13) + resize(dout_11_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_9_re_signed, 13) - resize(dout_11_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_9_im_signed, 13) + resize(dout_11_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_9_im_signed, 13) - resize(dout_11_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_9_re_signed, 13) + resize(dout_11_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_9_re_signed, 13) - resize(dout_11_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_9_im_signed, 13) + resize(dout_11_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_9_im_signed, 13) - resize(dout_11_im_signed, 13);
    END IF;
