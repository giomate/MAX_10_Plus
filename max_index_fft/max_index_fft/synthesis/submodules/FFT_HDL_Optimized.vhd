-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\FFT_HDL_Optimized.vhd
...
-- Source Path: max_10_frequency_index/max_10_index_frequency/FFT_streamer/FFT HDL Optimized
-- Hierarchy Level: 2
-- 
-- FFT HDL Optimized
-- 
...
ENTITY FFT_HDL_Optimized IS
  PORT( clk                               :   IN    std_logic;
        ...
        dataIn                            :   IN    vector_of_std_logic_vector12(0 TO 31);  -- sfix12 [32]
...
ARCHITECTURE rtl OF FFT_HDL_Optimized IS
  ...
  -- Signals
  SIGNAL dataIn_signed                    : vector_of_std_logic_vector12(0 TO 31);  -- ufix12 [32]
  SIGNAL rotate_1                         : std_logic;  -- ufix1
  SIGNAL rotate_1_1                       : std_logic;  -- ufix1
  SIGNAL dtc_im                           : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_1                         : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_2                         : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_3                         : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_4                         : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_5                         : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_6                         : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_7                         : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_8                         : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_9                         : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_10                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_11                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_12                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_13                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_14                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_15                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_16                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_17                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_18                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_19                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_20                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_21                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_22                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_23                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_24                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_25                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_26                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_27                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_28                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_29                        : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dtc_im_30                        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dtc_im_31                        : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  u_SDNF1_1_1 : RADIX22FFT_SDNF1_1
    PORT MAP( clk => clk,
              ...
              twdlXdin_1_re => dataIn_signed(0),  -- sfix12
              twdlXdin_1_im => std_logic_vector(dtc_im),  -- sfix12
              twdlXdin_17_re => dataIn_signed(16),  -- sfix12
              twdlXdin_17_im => std_logic_vector(dtc_im_1),  -- sfix12
  ...
  u_SDNF1_1_17 : RADIX22FFT_SDNF1_1_block7
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_9_re => dataIn_signed(8),  -- sfix12
              twdlXdin_9_im => std_logic_vector(dtc_im_2),  -- sfix12
              twdlXdin_25_re => dataIn_signed(24),  -- sfix12
              twdlXdin_25_im => std_logic_vector(dtc_im_3),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_3 : RADIX22FFT_SDNF1_1_block
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_2_re => dataIn_signed(1),  -- sfix12
              twdlXdin_2_im => std_logic_vector(dtc_im_4),  -- sfix12
              twdlXdin_18_re => dataIn_signed(17),  -- sfix12
              twdlXdin_18_im => std_logic_vector(dtc_im_5),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_19 : RADIX22FFT_SDNF1_1_block8
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_10_re => dataIn_signed(9),  -- sfix12
              twdlXdin_10_im => std_logic_vector(dtc_im_6),  -- sfix12
              twdlXdin_26_re => dataIn_signed(25),  -- sfix12
              twdlXdin_26_im => std_logic_vector(dtc_im_7),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_9 : RADIX22FFT_SDNF1_1_block3
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_5_re => dataIn_signed(4),  -- sfix12
              twdlXdin_5_im => std_logic_vector(dtc_im_8),  -- sfix12
              twdlXdin_21_re => dataIn_signed(20),  -- sfix12
              twdlXdin_21_im => std_logic_vector(dtc_im_9),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_25 : RADIX22FFT_SDNF1_1_block11
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_13_re => dataIn_signed(12),  -- sfix12
              twdlXdin_13_im => std_logic_vector(dtc_im_10),  -- sfix12
              twdlXdin_29_re => dataIn_signed(28),  -- sfix12
              twdlXdin_29_im => std_logic_vector(dtc_im_11),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_11 : RADIX22FFT_SDNF1_1_block4
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_6_re => dataIn_signed(5),  -- sfix12
              twdlXdin_6_im => std_logic_vector(dtc_im_12),  -- sfix12
              twdlXdin_22_re => dataIn_signed(21),  -- sfix12
              twdlXdin_22_im => std_logic_vector(dtc_im_13),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_27 : RADIX22FFT_SDNF1_1_block12
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_14_re => dataIn_signed(13),  -- sfix12
              twdlXdin_14_im => std_logic_vector(dtc_im_14),  -- sfix12
              twdlXdin_30_re => dataIn_signed(29),  -- sfix12
              twdlXdin_30_im => std_logic_vector(dtc_im_15),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_5 : RADIX22FFT_SDNF1_1_block1
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_3_re => dataIn_signed(2),  -- sfix12
              twdlXdin_3_im => std_logic_vector(dtc_im_16),  -- sfix12
              twdlXdin_19_re => dataIn_signed(18),  -- sfix12
              twdlXdin_19_im => std_logic_vector(dtc_im_17),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_21 : RADIX22FFT_SDNF1_1_block9
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_11_re => dataIn_signed(10),  -- sfix12
              twdlXdin_11_im => std_logic_vector(dtc_im_18),  -- sfix12
              twdlXdin_27_re => dataIn_signed(26),  -- sfix12
              twdlXdin_27_im => std_logic_vector(dtc_im_19),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_7 : RADIX22FFT_SDNF1_1_block2
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_4_re => dataIn_signed(3),  -- sfix12
              twdlXdin_4_im => std_logic_vector(dtc_im_20),  -- sfix12
              twdlXdin_20_re => dataIn_signed(19),  -- sfix12
              twdlXdin_20_im => std_logic_vector(dtc_im_21),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_23 : RADIX22FFT_SDNF1_1_block10
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_12_re => dataIn_signed(11),  -- sfix12
              twdlXdin_12_im => std_logic_vector(dtc_im_22),  -- sfix12
              twdlXdin_28_re => dataIn_signed(27),  -- sfix12
              twdlXdin_28_im => std_logic_vector(dtc_im_23),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_13 : RADIX22FFT_SDNF1_1_block5
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_7_re => dataIn_signed(6),  -- sfix12
              twdlXdin_7_im => std_logic_vector(dtc_im_24),  -- sfix12
              twdlXdin_23_re => dataIn_signed(22),  -- sfix12
              twdlXdin_23_im => std_logic_vector(dtc_im_25),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_29 : RADIX22FFT_SDNF1_1_block13
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_15_re => dataIn_signed(14),  -- sfix12
              twdlXdin_15_im => std_logic_vector(dtc_im_26),  -- sfix12
              twdlXdin_31_re => dataIn_signed(30),  -- sfix12
              twdlXdin_31_im => std_logic_vector(dtc_im_27),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_15 : RADIX22FFT_SDNF1_1_block6
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_8_re => dataIn_signed(7),  -- sfix12
              twdlXdin_8_im => std_logic_vector(dtc_im_28),  -- sfix12
              twdlXdin_24_re => dataIn_signed(23),  -- sfix12
              twdlXdin_24_im => std_logic_vector(dtc_im_29),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  u_SDNF1_1_31 : RADIX22FFT_SDNF1_1_block14
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              twdlXdin_16_re => dataIn_signed(15),  -- sfix12
              twdlXdin_16_im => std_logic_vector(dtc_im_30),  -- sfix12
              twdlXdin_32_re => dataIn_signed(31),  -- sfix12
              twdlXdin_32_im => std_logic_vector(dtc_im_31),  -- sfix12
              twdlXdin_1_vld => twdlXdin_1_vld,
              softReset => softReset,
  ...
  dtc_im_2 <= to_signed(16#000#, 12);

  dtc_im_3 <= to_signed(16#000#, 12);

  rotate_3 <= '0';

  dtc_im_4 <= to_signed(16#000#, 12);

  dtc_im_5 <= to_signed(16#000#, 12);

  dtc_im_6 <= to_signed(16#000#, 12);

  dtc_im_7 <= to_signed(16#000#, 12);
  ...
  dtc_im_8 <= to_signed(16#000#, 12);

  dtc_im_9 <= to_signed(16#000#, 12);

  dtc_im_10 <= to_signed(16#000#, 12);

  dtc_im_11 <= to_signed(16#000#, 12);

  rotate_11 <= '0';

  dtc_im_12 <= to_signed(16#000#, 12);

  dtc_im_13 <= to_signed(16#000#, 12);

  dtc_im_14 <= to_signed(16#000#, 12);

  dtc_im_15 <= to_signed(16#000#, 12);

  rotate_5 <= '0';

  dtc_im_16 <= to_signed(16#000#, 12);

  dtc_im_17 <= to_signed(16#000#, 12);

  dtc_im_18 <= to_signed(16#000#, 12);

  dtc_im_19 <= to_signed(16#000#, 12);

  rotate_7 <= '0';

  dtc_im_20 <= to_signed(16#000#, 12);

  dtc_im_21 <= to_signed(16#000#, 12);

  dtc_im_22 <= to_signed(16#000#, 12);

  dtc_im_23 <= to_signed(16#000#, 12);

  rotate_13 <= '0';

  dtc_im_24 <= to_signed(16#000#, 12);

  dtc_im_25 <= to_signed(16#000#, 12);

  dtc_im_26 <= to_signed(16#000#, 12);

  dtc_im_27 <= to_signed(16#000#, 12);

  rotate_15 <= '0';

  dtc_im_28 <= to_signed(16#000#, 12);

  dtc_im_29 <= to_signed(16#000#, 12);

  dtc_im_30 <= to_signed(16#000#, 12);

  dtc_im_31 <= to_signed(16#000#, 12);
