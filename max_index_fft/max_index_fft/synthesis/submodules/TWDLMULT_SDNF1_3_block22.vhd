-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block22.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block22
...
ENTITY TWDLMULT_SDNF1_3_block22 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_47_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_47_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_48_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_48_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_48_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_47_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_47_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_48_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_48_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_47_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block22;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block22 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block42
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block43
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block42
    USE ENTITY work.Complex4Multiply_block42(rtl);

  FOR ALL : Complex4Multiply_block43
    USE ENTITY work.Complex4Multiply_block43(rtl);
  ...
  SIGNAL twdlXdin_47_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_47_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_48_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_48_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block42
    PORT MAP( clk => clk,
              ...
              twdl_3_47_re => twdl_3_47_re,  -- sfix12_En10
              twdl_3_47_im => twdl_3_47_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_47_re => twdlXdin_47_re_tmp,  -- sfix12
              twdlXdin_47_im => twdlXdin_47_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block43
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_48_re => twdl_3_48_re,  -- sfix12_En10
              twdl_3_48_im => twdl_3_48_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_48_re => twdlXdin_48_re_tmp,  -- sfix12
              twdlXdin_48_im => twdlXdin_48_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_47_vld
              );
