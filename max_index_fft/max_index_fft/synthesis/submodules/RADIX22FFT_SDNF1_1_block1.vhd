-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\RADIX22FFT_SDNF1_1_block1.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block1 IS
  ...
  -- Signals
  SIGNAL twdlXdin_3_re_signed             : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_3_im_signed             : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_3_re_signed, 13) + resize(twdlXdin_19_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_3_re_signed, 13) - resize(twdlXdin_19_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_3_im_signed, 13) + resize(twdlXdin_19_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_3_im_signed, 13) - resize(twdlXdin_19_im_signed, 13);
    END IF;
