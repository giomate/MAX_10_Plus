-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\Complex4Multiply_block74.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block74
...
ENTITY Complex4Multiply_block74 IS
...
END Complex4Multiply_block74;


ARCHITECTURE rtl OF Complex4Multiply_block74 IS
  ...
  SIGNAL twdlXdin_22_re_tmp               : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_22_im_tmp               : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  twdlXdin_22_re_tmp <= mulResFP_re(21 DOWNTO 10);

  twdlXdin_22_re <= std_logic_vector(twdlXdin_22_re_tmp);

  twdlXdin_22_im_tmp <= mulResFP_im(21 DOWNTO 10);
