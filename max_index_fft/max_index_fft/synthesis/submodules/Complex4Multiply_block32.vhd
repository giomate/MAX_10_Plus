-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\Complex4Multiply_block32.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block32
-- Source Path: max_10_frequency_index/max_10_index_frequency/FFT_streamer/FFT HDL Optimized/RADIX22FFT_SDNF1_5/Complex4Multiply
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Complex4Multiply_block32 IS
...
END Complex4Multiply_block32;


ARCHITECTURE rtl OF Complex4Multiply_block32 IS
  ...
  SIGNAL twdl_5_12_re_signed              : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_re_reg                      : signed(11 DOWNTO 0) := to_signed(16#000#, 12);  -- sfix12_En10
  SIGNAL twdl_5_12_im_signed              : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dinXTwdl2_re_tmp                 : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dinXTwdl2_im_tmp                 : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  dinXTwdl2_re_tmp <= mulResFP_re(21 DOWNTO 10);

  dinXTwdl2_re <= std_logic_vector(dinXTwdl2_re_tmp);

  dinXTwdl2_im_tmp <= mulResFP_im(21 DOWNTO 10);
