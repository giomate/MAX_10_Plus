-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_4_block23.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_4_block23
...
ENTITY RADIX22FFT_SDNF2_4_block23 IS
  PORT( clk                               :   IN    std_logic;
        enb_1_64_0                        :   IN    std_logic;
        rotate_49                         :   IN    std_logic;  -- ufix1
        dout_49_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_49_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_57_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_57_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_1_vld                        :   IN    std_logic;
        softReset                         :   IN    std_logic;
        dout_49_re_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_49_im_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
...
END RADIX22FFT_SDNF2_4_block23;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block23 IS

  -- Signals
  SIGNAL dout_49_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_49_im_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_57_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_57_im_signed                : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_49_re_signed, dout_57_im_signed, dout_57_re_signed, rotate_49)
  ...
  BEGIN
    ...
    IF rotate_49 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_49_re_signed, 13) + resize(dout_57_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_49_re_signed, 13) - resize(dout_57_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_49_im_signed, 13) + resize(dout_57_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_49_im_signed, 13) - resize(dout_57_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_49_re_signed, 13) + resize(dout_57_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_49_re_signed, 13) - resize(dout_57_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_49_im_signed, 13) + resize(dout_57_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_49_im_signed, 13) - resize(dout_57_im_signed, 13);
    END IF;
