-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_4_block16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_4_block16
...
ENTITY RADIX22FFT_SDNF2_4_block16 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_35_re_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_35_im_1                      :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
...
END RADIX22FFT_SDNF2_4_block16;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block16 IS
  ...
  BEGIN
    ...
    IF rotate_35 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_35_re_signed, 13) + resize(dout_43_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_35_re_signed, 13) - resize(dout_43_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_35_im_signed, 13) + resize(dout_43_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_35_im_signed, 13) - resize(dout_43_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_35_re_signed, 13) + resize(dout_43_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_35_re_signed, 13) - resize(dout_43_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_35_im_signed, 13) + resize(dout_43_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_35_im_signed, 13) - resize(dout_43_im_signed, 13);
    END IF;
