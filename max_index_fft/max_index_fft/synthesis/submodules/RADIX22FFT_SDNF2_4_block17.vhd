-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_4_block17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDNF2_4_block17
...
ENTITY RADIX22FFT_SDNF2_4_block17 IS
...
END RADIX22FFT_SDNF2_4_block17;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block17 IS
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_37_re_signed, dout_45_im_signed, dout_45_re_signed, rotate_37)
  ...
  BEGIN
    ...
    IF rotate_37 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_37_re_signed, 13) + resize(dout_45_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_37_re_signed, 13) - resize(dout_45_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_37_im_signed, 13) + resize(dout_45_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_37_im_signed, 13) - resize(dout_45_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_37_re_signed, 13) + resize(dout_45_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_37_re_signed, 13) - resize(dout_45_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_37_im_signed, 13) + resize(dout_45_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_37_im_signed, 13) - resize(dout_45_im_signed, 13);
    END IF;
