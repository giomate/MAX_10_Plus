-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block20.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block20
...
ENTITY TWDLMULT_SDNF1_3_block20 IS
  PORT( clk                               :   IN    std_logic;
        enb_1_64_0                        :   IN    std_logic;
        dout_53_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_53_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_55_re                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_55_im                        :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12
        dout_2_vld                        :   IN    std_logic;
        twdl_3_43_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_43_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_44_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_44_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_44_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_43_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_43_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_44_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_44_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_43_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block20;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block20 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block38
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block39
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block38
    USE ENTITY work.Complex4Multiply_block38(rtl);

  FOR ALL : Complex4Multiply_block39
    USE ENTITY work.Complex4Multiply_block39(rtl);

  -- Signals
  SIGNAL dout_53_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dout_53_im_signed                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL twdlXdin_43_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_43_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin1_vld                    : std_logic;
  SIGNAL dout_55_re_signed                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL dout_55_im_signed                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL twdlXdin_44_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_44_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block38
    PORT MAP( clk => clk,
              ...
              twdl_3_43_re => twdl_3_43_re,  -- sfix12_En10
              twdl_3_43_im => twdl_3_43_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_43_re => twdlXdin_43_re_tmp,  -- sfix12
              twdlXdin_43_im => twdlXdin_43_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block39
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_44_re => twdl_3_44_re,  -- sfix12_En10
              twdl_3_44_im => twdl_3_44_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_44_re => twdlXdin_44_re_tmp,  -- sfix12
              twdlXdin_44_im => twdlXdin_44_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_43_vld
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_re_dly1 <= dout_53_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_im_dly1 <= dout_53_im_signed;
      END IF;
    END IF;
  ...
  dout_55_re_signed <= signed(dout_55_re);

  intdelay_9_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_re_dly1 <= dout_55_re_signed;
      END IF;
    END IF;
  ...
  dout_55_im_signed <= signed(dout_55_im);

  intdelay_11_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_im_dly1 <= dout_55_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_43_re <= twdlXdin_43_re_tmp;

  twdlXdin_43_im <= twdlXdin_43_im_tmp;

  twdlXdin_44_re <= twdlXdin_44_re_tmp;

  twdlXdin_44_im <= twdlXdin_44_im_tmp;
