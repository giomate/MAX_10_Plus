-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_4_block4.vhd
  ...
  BEGIN
    ...
    IF rotate_11 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_11_re_signed, 13) + resize(dout_15_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_11_re_signed, 13) - resize(dout_15_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_11_im_signed, 13) + resize(dout_15_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_11_im_signed, 13) - resize(dout_15_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_11_re_signed, 13) + resize(dout_15_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_11_re_signed, 13) - resize(dout_15_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_11_im_signed, 13) + resize(dout_15_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_11_im_signed, 13) - resize(dout_15_im_signed, 13);
    END IF;
