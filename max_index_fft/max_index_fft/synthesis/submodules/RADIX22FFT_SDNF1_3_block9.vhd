-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF1_3_block9.vhd
...
ENTITY RADIX22FFT_SDNF1_3_block9 IS
...
END RADIX22FFT_SDNF1_3_block9;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_3_block9 IS
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_19_re_signed, 13) + resize(twdlXdin_23_re_signed, 13);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_19_re_signed, 13) - resize(twdlXdin_23_re_signed, 13);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_19_im_signed, 13) + resize(twdlXdin_23_im_signed, 13);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_19_im_signed, 13) - resize(twdlXdin_23_im_signed, 13);
    END IF;
