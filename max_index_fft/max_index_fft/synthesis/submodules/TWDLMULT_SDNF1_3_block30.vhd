-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block30.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block30
...
ENTITY TWDLMULT_SDNF1_3_block30 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_63_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_63_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_64_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_64_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_64_vld                     :   IN    std_logic;
        softReset                         :   IN    std_logic;
        twdlXdin_63_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_63_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_64_re                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_64_im                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
        twdlXdin_63_vld                   :   OUT   std_logic
        );
END TWDLMULT_SDNF1_3_block30;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block30 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block57
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block58
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block57
    USE ENTITY work.Complex4Multiply_block57(rtl);

  FOR ALL : Complex4Multiply_block58
    USE ENTITY work.Complex4Multiply_block58(rtl);
  ...
  SIGNAL twdlXdin_63_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_63_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_64_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_64_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block57
    PORT MAP( clk => clk,
              ...
              twdl_3_63_re => twdl_3_63_re,  -- sfix12_En10
              twdl_3_63_im => twdl_3_63_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_63_re => twdlXdin_63_re_tmp,  -- sfix12
              twdlXdin_63_im => twdlXdin_63_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block58
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_64_re => twdl_3_64_re,  -- sfix12_En10
              twdl_3_64_im => twdl_3_64_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_64_re => twdlXdin_64_re_tmp,  -- sfix12
              twdlXdin_64_im => twdlXdin_64_im_tmp,  -- sfix12
              twdlXdin2_vld => twdlXdin_63_vld
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_re_dly1 <= dout_62_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_im_dly1 <= dout_62_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_re_dly1 <= dout_64_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_im_dly1 <= dout_64_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_63_re <= twdlXdin_63_re_tmp;

  twdlXdin_63_im <= twdlXdin_63_im_tmp;

  twdlXdin_64_re <= twdlXdin_64_re_tmp;

  twdlXdin_64_im <= twdlXdin_64_im_tmp;
