-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\TWDLMULT_SDNF1_3_block17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_3_block17
...
ENTITY TWDLMULT_SDNF1_3_block17 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_3_37_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_37_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_38_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_38_im                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
        twdl_3_38_vld                     :   IN    std_logic;
...
END TWDLMULT_SDNF1_3_block17;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block17 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block32
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block33
    PORT( clk                             :   IN    std_logic;
          enb_1_64_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block32
    USE ENTITY work.Complex4Multiply_block32(rtl);

  FOR ALL : Complex4Multiply_block33
    USE ENTITY work.Complex4Multiply_block33(rtl);
  ...
  SIGNAL twdlXdin_37_re_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_37_im_tmp               : std_logic_vector(11 DOWNTO 0);  -- ufix12
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block32
    PORT MAP( clk => clk,
              ...
              twdl_3_37_re => twdl_3_37_re,  -- sfix12_En10
              twdl_3_37_im => twdl_3_37_im,  -- sfix12_En10
              softReset => softReset,
              twdlXdin_37_re => twdlXdin_37_re_tmp,  -- sfix12
              twdlXdin_37_im => twdlXdin_37_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block33
    PORT MAP( clk => clk,
              enb_1_64_0 => enb_1_64_0,
              ...
              twdl_3_38_re => twdl_3_38_re,  -- sfix12_En10
              twdl_3_38_im => twdl_3_38_im,  -- sfix12_En10
              softReset => softReset,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_re_dly1 <= dout_41_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din1_im_dly1 <= dout_41_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_re_dly1 <= dout_43_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_64_0 = '1' THEN
        din2_im_dly1 <= dout_43_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_37_re <= twdlXdin_37_re_tmp;

  twdlXdin_37_im <= twdlXdin_37_im_tmp;
