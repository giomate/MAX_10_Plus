-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\Complex4Multiply_block76.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block76
...
ENTITY Complex4Multiply_block76 IS
...
END Complex4Multiply_block76;


ARCHITECTURE rtl OF Complex4Multiply_block76 IS
  ...
  SIGNAL twdlXdin_24_re_tmp               : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL twdlXdin_24_im_tmp               : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  twdlXdin_24_re_tmp <= mulResFP_re(21 DOWNTO 10);

  twdlXdin_24_re <= std_logic_vector(twdlXdin_24_re_tmp);

  twdlXdin_24_im_tmp <= mulResFP_im(21 DOWNTO 10);
