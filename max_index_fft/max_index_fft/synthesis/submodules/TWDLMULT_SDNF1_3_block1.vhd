-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10_Plus\fft_index\max_10_frequency_index\TWDLMULT_SDNF1_3_block1.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block1 IS
  ...
  SIGNAL twdlXdin_5_re_tmp                : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_5_im_tmp                : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL twdlXdin_6_re_tmp                : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL twdlXdin_6_im_tmp                : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_MUL4_1 : Complex4Multiply_block2
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_5_re => twdlXdin_5_re_tmp,  -- sfix12
              twdlXdin_5_im => twdlXdin_5_im_tmp,  -- sfix12
              twdlXdin1_vld => twdlXdin1_vld
              );

  u_MUL4_2 : Complex4Multiply_block3
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              ...
              softReset => softReset,
              twdlXdin_6_re => twdlXdin_6_re_tmp,  -- sfix12
              twdlXdin_6_im => twdlXdin_6_im_tmp,  -- sfix12
