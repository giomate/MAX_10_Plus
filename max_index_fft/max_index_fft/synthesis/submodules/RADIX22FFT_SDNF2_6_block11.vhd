-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\MAX_10\FFT\max_10_frequency_index\RADIX22FFT_SDNF2_6_block11.vhd
...
ENTITY RADIX22FFT_SDNF2_6_block11 IS
...
END RADIX22FFT_SDNF2_6_block11;


ARCHITECTURE rtl OF RADIX22FFT_SDNF2_6_block11 IS
  ...
  SIGNAL dout_25_re_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_25_im_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_26_re_tmp                   : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL dout_26_im_tmp                   : signed(11 DOWNTO 0);  -- sfix12
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_25_re_signed, dout_27_im_signed, dout_27_re_signed, rotate_25)
  ...
  BEGIN
    ...
    IF rotate_25 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_25_re_signed, 13) + resize(dout_27_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_25_re_signed, 13) - resize(dout_27_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_25_im_signed, 13) + resize(dout_27_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_25_im_signed, 13) - resize(dout_27_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_25_re_signed, 13) + resize(dout_27_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_25_re_signed, 13) - resize(dout_27_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_25_im_signed, 13) + resize(dout_27_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_25_im_signed, 13) - resize(dout_27_im_signed, 13);
    END IF;
    sra_temp := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf1_re_reg, 1);
    dout_25_re_tmp <= sra_temp(11 DOWNTO 0);
    sra_temp_0 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf1_im_reg, 1);
    dout_25_im_tmp <= sra_temp_0(11 DOWNTO 0);
    sra_temp_1 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf2_re_reg, 1);
    dout_26_re_tmp <= sra_temp_1(11 DOWNTO 0);
    sra_temp_2 := SHIFT_RIGHT(Radix22ButterflyG2_NF_btf2_im_reg, 1);
    dout_26_im_tmp <= sra_temp_2(11 DOWNTO 0);
